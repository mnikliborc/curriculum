...
* [Optional] The Heroku Toolbelt, a program for putting your Clojure application on the web
* [Optional] Git, a program for managing your program's code, which is included in the Heroku Toolbelt
